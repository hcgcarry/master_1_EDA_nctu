...
struct vertex{
    ...
    friend ostream& operator<<(ostream& os ,struct vertex& vertexObj){
        ...
        cout << " leftChild:" << vertexObj.leftChild << " rightChild:" << vertexObj.rightChild ;
        cout <<"curMaxId:" << vertex::curMaxId << endl;
...
class caculateProbability{
    ...
    float computeRecur(struct vertex* root,const Info& InfoObj){
        ...
        return right * TokenProbability + left * (1-TokenProbability);
    }
